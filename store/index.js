export const state = () => ({
  ...
  portfolioItems: {
    EzLandlord: {
      path: '/projects/ez-landlord/',
      thumbnailPath: '/ez_mobile_thumb.png',
      images: [
        '/ez_home.png',
        '/ez_document_search.png',
        '/ez_document_details.png',
        '/ez_wizard.png',
        '/ez_rent_payment_details.png',
        '/ez_screening.png',
        '/ez_pricing.png'
      ],
    ...
    AvoyaDashboard: {
      ...
      images: [
        '/avoya_dashboard_top.png',
        '/avoya_dashboard_metric.png',
        '/avoya_dashboard_bot.png',
        '/avoya_dashboard_modal.png'
      ],
      title: 'B2B Dashboard',
      description:
    ...
    AvoyaMembership: {
      ...
      images: [
        '/avoya_membership_home.png',
        '/avoya_membership_favorites.png',
        '/avoya_membership_settings.png'
      ],
    ...
    Techsd: {
      ...
      description:
        '<p class="pb-4">I was hired as a web administrator for Tech San Diego as the growing company needed someone to take remedial site updates off their hands. I had been maintaining their site using the Joomla! until management tasked me with migrating the site to WordPress, as well as giving it a fresh new look. It was a great learning experience and gave me exposure to UX/UI.</p>',
    ...
    Nixon: {
      ...
      title: 'Nixon',
      description:
        '<p class="pb-4">I maintained contract work with Nixon to assist in updating seasonal pages of their Ecommerce site, as well as, making email templates. Typical functions included taking a PSD File and implementing a HTML structure, CSS, linking images, and updating foreign languages.</p>',
    ...
    ComingSoon: {
      ...
      description:
        '<p class="pb-4">A "teaser" poster for a highly anticipated book. This poster was posted throughout the author\'s various social media outlets.</p>',
    ...
    SierraBotanicals: {
      ...
      description:
        '<p class="pb-4">I created a simple postcard to display this company various product flavors</p>',
      techUsed: ['Illustrator', 'PhotoShop'],
      siteLink: ''
    },
    CathedralCatholic: {
    ...
    Logos: {
      ...
      images: [
        '/logos-oiling.png',
        '/logos-oiling-tote.png',
        '/logos-silverDragon.png',
        '/logos-silverDragon-alt.png',
        '/logos-ssf.png',
        '/logos-taste.png'
      ],
      title: 'Logo Design',
